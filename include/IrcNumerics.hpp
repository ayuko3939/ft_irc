...
# define MODE_REQ_L_LIMIT	"[!] limit requirements: (1-4)\r\n"
...
// (444) ERR_USERONINVITED : 既に招待されている*
# define ERR_USERONINVITED(client, nick, channel) (":localhost 444 " + client + " " + nick + " #" + channel + " :is already invited\r\n")
