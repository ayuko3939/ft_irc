...
// # define RPL_INVITE(IRC_PREFIX, guest, channelName) (IRC_PREFIX + " INVITE " + guest + " " + channelName + "\r\n")
...
// # define RPL_PART(IRC_PREFIX, channel, nickname, reason) (IRC_PREFIX + " PART #" + channel + " :" + nickname + reason + "\r\n")
